...
export default function UserDashboard() {
    ...
    return (
        <>
<section className="bg-gray-500 bg-blend-multiply dark:bg-gray-500 bg-cover bg-[url('/images/bg-road.jpg')] bg-center bg-no-repeat min-h-screen flex items-center justify-center py-12">
            ...
            {currentReservations.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {currentReservations.map((reservation) => (
                        <Link key={reservation._id} to={`/rent-a-motorcycle/${reservation._id}`} className="group">
