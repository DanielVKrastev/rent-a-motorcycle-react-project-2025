    ...
    <div className="m-10 max-w-lg mx-auto p-8 bg-white rounded-2xl shadow-lg border border-gray-200">
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <div className="w-full">
          ...
          <input id="name" value={name} onChange={(e) => setName(e.target.value)} className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div className="w-full">
