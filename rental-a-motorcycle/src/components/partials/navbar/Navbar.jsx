                                        ...
                                        {isOpenProfile && (
                                            <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-44 divide-y divide-gray-500 rounded-lg shadow-sm dark:bg-gray-700">
                                                ...
                                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                    ...
                                                    <li>
                                                        <Link to="/user-dashboard/support-request" onClick={() => setIsOpenProfile(false)} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Support Request</Link>
                                                    </li>
                                                </ul>
                                                <div className="py-1">
